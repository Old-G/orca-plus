...
export function useTaskSourceProviderReadiness(
  ...
  const clickUpConnectedRaw = useAppStore((s) => s.clickUpStatus.connected)
  ...
  const clickUpConnected = !clickUpChecking && clickUpConnectedRaw
  ...
  return useMemo(() => {
    ...
    return {
      ...
      clickup: {
        ...
        checking: clickUpChecking,
        visible: visible.has('clickup')
      }
    }
  }, [
    clickUpChecking,
